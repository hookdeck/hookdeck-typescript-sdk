...
export class Request {
    ...
    ): Promise<Intercom.RequestPaginatedResult> {
        const {
            id,
            status,
            rejectionCause,
     ...
     */
    public async retrieve(id: string, requestOptions?: Request.RequestOptions): Promise<Intercom.Request> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.Default,
                `requests/${id}`
     ...
     */
    public async retrieveBody(id: string, requestOptions?: Request.RequestOptions): Promise<Intercom.RawBody> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.Default,
    ...
    public async listIgnoredEvent(
        ...
        requestOptions?: Request.RequestOptions
    ): Promise<Intercom.IgnoredEventPaginatedResult> {
