...
export const ConnectionCreateRequestSource: core.serialization.ObjectSchema<
    serializers.ConnectionCreateRequestSource.Raw,
    Hookdeck.ConnectionCreateRequestSource
...
export declare namespace ConnectionCreateRequestSource {
    interface Raw {
        name: string;
